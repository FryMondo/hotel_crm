<template>
  <div class="navbar">
    ...
    <div class="navigation-wrapper">
      <button class="navigation-btn" @click="scrollToWelcome">
        <strong>Навігація</strong>
      </button>
      <div class="navigation-menu">
        <button @click="scrollToWelcome"><strong>Вітання</strong></button>
        <hr />
        <button @click="scrollToInformation">
          <strong>Інформація про готель</strong>
        </button>
        <hr />
        <button @click="scrollToRoomInformation">
          <strong>Інформація про кімнати</strong>
        </button>
        <hr />
    ...
    <div class="navigation-wrapper">
      ...
      <div class="navigation-menu">
        <button @click="$router.push('/reserved')">
          <strong>Заброньовані номери</strong>
        </button>
        <hr />
        <button @click="$router.push('/additional')">
          <strong>Додати інформацію</strong>
        </button>
        <hr />
        <div class="secret" v-if="isAdmin">
          <button @click="$router.push('/allUsers')">
            <strong>Всі користувачі</strong>
          </button>
          <hr />
        </div>
  ...
  <div class="welcome-text" id="welcome">
    <p>
      <strong
        >Вітаємо вас, {{ showUsername() }}, на сторінці нашого готелю!</strong
      >
    </p>
  </div>
    ...
    <div class="info-content">
      <div class="image-container">
        <transition name="fade" mode="out-in">
          <img
            :key="currentImageHotel"
            :src="currentImageHotel"
            :alt="altTextHotel"
            class="hotel-image"
          />
        </transition>
      ...
      <div class="text-container">
        <p>
          Чотирьохзірковий Готель Україна розташований у серці Києва – на
          Майдані Незалежності. Це унікальне місце, де перетинаються культурне,
          політичне та розважальне життя української столиці. Неподалік
          розташовані найвідоміші київські театри, Секретаріат Президента
          України, Верховна Рада, Кабінет Міністрів, Національний банк, мерія,
          головпоштамт, нічні клуби та великі торговельні центри.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="hotel_info" id="room-information">
    ...
    <div class="info-content">
      <div class="text-container">
        <ul>
          <li>
            В готелі «Україна» є обладнане бомбосховище з безкоштовним Wi-Fi,
            туалетом, душем, TV, та окремим виходом на вулицю.
          </li>
          <li>Система оповіщення про повітряну тривогу або іншу небезпеку.</li>
          <li>
            Проінструктований персонал щодо дій у разі екстреної ситуації.
          </li>
      ...
      <div class="image-container">
        <transition name="fade" mode="out-in">
          <img
            :key="currentImageRoom"
            :src="currentImageRoom"
            :alt="altTextRoom"
            class="hotel-image"
          />
        </transition>
  ...
  <div class="placement" id="location">
    ...
    <div class="address">
      <p>
        Готель знаходиться за такою адресою:
        <strong>м. Київ, вул. Інститутська, 4</strong>
      </p>
    </div>
    <div class="map">
      <iframe
    ...
    <div class="groups">
      ...
      <p>
        <a href="https://www.instagram.com/" target="_blank">
          <img src="../../public/pictures/social/instagram.png" alt="instagram"
        /></a>
      </p>
      <p>
        <a href="https://t.me/" target="_blank">
          <img src="../../public/pictures/social/telegram.png" alt="telegram"
        /></a>
      </p>
      <p>
        <a href="https://www.facebook.com/" target="_blank">
          <img src="../../public/pictures/social/facebook.png" alt="facebook"
        /></a>
      </p>
    </div>
  </div>
...
export default {
  data() {
    return {
      imagesHotel: [
        './pictures/hotel_info/main_hotel1.jpeg',
        './pictures/hotel_info/main_hotel2.jpeg',
        './pictures/hotel_info/main_hotel3.jpeg',
      ],
      imagesRoom: [
        './pictures/room_info/main_room1.jpg',
        './pictures/room_info/main_room2.jpg',
  ...
  methods: {
    ...
    rotateImage() {
      this.currentImageIndex =
        (this.currentImageIndex + 1) % this.imagesHotel.length;
    },
  },
};
</script>
